...
//		Naravno u glavnom kreirati objekte i testirati funkcionalnosti 
		...
		Racun svetolik = new Racun("170-289328923-23", "Svetolik Kljajic", 100000);
		Racun pera = new Racun("3333-3333", "Pera Peric", 0);
		
		
		svetolik.stampaj();
		pera.stampaj();
		
		Transakcija transakcija1 = new Transakcija("123", svetolik, pera);
